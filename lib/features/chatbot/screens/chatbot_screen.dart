...
class _ChatbotScreenState extends ConsumerState<ChatbotScreen> {
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Row(
            children: [
              ...
              Column(
                ...
                children: [
                  Text('GreenMind AI', style: AppTextStyles.title),
                  Text('Plant Assistant', style: AppTextStyles.caption),
                ],
              ),
            ],
          ),
          ...
          actions: [
            IconButton(
              tooltip: 'Clear chat',
              onPressed: state.messages.length <= 1 ? null : notifier.clearChat,
          ...
          children: [
            ...
            Expanded(
              child: state.messages.length == 1
                  ? _buildWelcomeContent(context, notifier)
  ...
  Widget _buildWelcomeContent(BuildContext context, ChatbotNotifier notifier) {
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          // SUGGESTIONS
          // ======================================================
          Text('Try asking', style: AppTextStyles.heading3),
  ...
  Widget _buildMessageList(ChatbotState state) {
    final int itemCount = state.messages.length + (state.isLoading ? 1 : 0);
